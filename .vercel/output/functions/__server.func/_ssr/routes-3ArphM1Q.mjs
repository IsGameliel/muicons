...
import { E as Heart, K as ArrowRight, N as Crown, R as CircleCheck, l as Sparkles, n as Users, o as Trophy } from "../_libs/lucide-react.mjs";
import { r as formatNumber } from "./format-DHr__noG.mjs";
import { t as PublicLayout } from "./PublicLayout-CVCzS5nS.mjs";
import { t as ContestantCard } from "./ContestantCard-Wf2Bjp9e.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-3ArphM1Q.js
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								...
								size: "lg",
								variant: "outline",
								className: "border-pearl/30 bg-pearl/10 text-pearl hover:bg-pearl/20",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									to: "/leaderboard",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trophy, { className: "mr-2 h-4 w-4" }), " Live Leaderboard"]
								})
							})]
						})
					]
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					{
						label: "Votes Cast",
						value: formatNumber(stats.data?.total_votes),
						Icon: Heart
					},
					{
						label: "Unique Voters",
						value: formatNumber(stats.data?.total_voters),
						Icon: Sparkles
					},
					{
						label: "Crown",
