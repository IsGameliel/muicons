  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-7xl text-gold-shine">404</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Vote for your favourite contestant in the MU Icons beauty pageant. Live leaderboard, transparent voting, premium experience." },
      { property: "og:title", content: "MU Icons — Crown Your Favourite" },
      { property: "og:description", content: "Premier university beauty pageant voting platform." },
